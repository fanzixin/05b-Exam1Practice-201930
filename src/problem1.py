...
def run_test_problem1a():
    ...
    # Test 4:
    expected = -0.306  # This is APPROXIMATELY the correct answer.
    print_expected_result_of_test([-100, 100], expected, test_results,
                                  format_string)
    actual = problem1a(-100, 100)
    print_actual_result_of_test(expected, actual, test_results, precision=3)
...
def run_test_problem1b():
    ...
    print_actual_result_of_test(expected, actual, test_results, precision=0)
    ...
    # Test 4:
    expected = 150  # This is APPROXIMATELY the correct answer.
    print_expected_result_of_test([9, 100], expected, test_results,
                                  format_string)
    actual = problem1b(9, 100)
    print_actual_result_of_test(expected, actual, test_results, precision=0)
